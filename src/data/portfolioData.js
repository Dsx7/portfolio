    ...
    projects: [
        {
            id: "1",
            name: "Zyplo",
            image: "https://i.ibb.co.com/rK4nRMw5/right-hero.webp", // Make sure to update this with a real image link for Zyplo
            shortDesc: "A developer-focused project management platform featuring AI-powered task generation, real-time collaboration, and advanced workflow tracking.",
            fullDesc: "Zyplo is a comprehensive project management solution designed to streamline team workflows and boost productivity. Built with a focus on speed and usability, it features a lightning-fast global search, customizable starred workspaces, and intuitive list views. The platform's standout feature is 'AI Kickstart,' which instantly generates tailored project backlogs, eliminating the blank-slate problem. With secure authentication, real-time updates via Socket.io, and seamless file attachments, Zyplo provides everything a modern team needs to manage their projects effectively from start to finish.",
            features: [
                "AI Kickstart: Instantly generates comprehensive project task backlogs.",
                "Global Search (Ctrl + K): Lightning-fast navigation across the entire platform.",
                "Real-time Collaboration: Live updates powered by Socket.io.",
                "Starred Workspaces: Quick access to important projects via the sidebar.",
                "Advanced Task Management: Includes List Views, Kanban boards, and file attachments."
            ],
        ...
        },
        {
            ...
            shortDesc: "A smart personal finance tracker with visual analytics and secure transaction management.",
        ...
        },
        {
            ...
            image: "https://i.ibb.co.com/6pVY2jX/dsx-converted-image.jpg",
