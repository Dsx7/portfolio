    ...
    <nav className={`fixed w-full top-0 z-50 transition-all duration-300 ${scrolled ? 'bg-[#020618]/90 backdrop-blur-lg border-b border-white/5 shadow-lg' : 'bg-transparent'}`}>
      <div className="max-w-[1470px] mx-auto px-6 h-20 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a href="https://drive.google.com/file/d/1I5CQ_ONY80iOr_d8vuFRpKUKKQRFv7CF/view?usp=drive_link" download className="px-5 py-2 text-sm font-bold text-black bg-primary rounded-full hover:bg-yellow-400 transition-transform hover:scale-105 shadow-lg shadow-primary/20 ml-4">
            Resume
          </a>
        </div>
        ...
        {isOpen && (
          ...
          >
            ...
            <motion.div 
              ...
              className="mt-12"
            >
               <a href="https://drive.google.com/file/d/1I5CQ_ONY80iOr_d8vuFRpKUKKQRFv7CF/view?usp=drive_link" download className="px-8 py-3 text-lg font-bold text-black bg-primary rounded-full shadow-xl">
                 Download Resume
               </a>
            </motion.div>
          </motion.div>
